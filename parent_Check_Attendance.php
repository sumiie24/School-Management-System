...
<section id="main-content">
			<section class="wrapper">
			      ...
			      <div class="stats-last-agile">
                    <form action="student_view_attendance.php" class="form-horizontal bucket-form" method="post">
				  <div class="form-group">
                    ...
                    <div class="col-lg-5">
                        <div class="input-group m-bot15">
                           ...
                           <select name="month" class="form-control m-bot15">
                                <option>Month</option>
                                ...
                                <input type="submit" class="btn btn-success" value="View!" name="monthview">
                                </span>
                        </div>
                    </div>
                    </div>
               <!-- </form>-->    
			<p style="color:blue;" align="center">-----------------------------------OR--------------------------------</p>

				<!--<form class="form-horizontal bucket-form" action="student_view_attendance.php" method="post">-->	
				    <div class="form-group">
				    <br>    
					<label class="col-sm-3 control-label">Select Date</label>
                        ...
                        <div class="input-group m-bot15">
                                ...
                                <span class="input-group-btn">
                                <input type="submit" value="View!" class="btn btn-success" name="dateview">
                                </span>
                        </div>
                        </div>
                    </div>
            ...
            <div class="agileits-w3layouts-stats">
					<div class="col-md-12 stats-info stats-last widget-shadow">
						<div class="stats-last-agile">
							<table class="table stats-table ">
					                        <tbody>
					                            ...
					                            <tr>
													...
													<td><h5 id="h5.-bootstrap-heading">Date<a class="anchorjs-link" href="#h5.-bootstrap-heading"><span class="anchorjs-icon"></span></a></h5></td>
												...
												if(((isset($_POST['dateview'])) | (isset($_POST['monthview'])))==0){
												$uname=$_SESSION["uname"];
												$result=mysqli_query($mysqli,"Select *from Student_Attendance where Student_Reg_Id='$uname' and Date='$current_date'");
												while($data=mysqli_fetch_array($result)){
												echo '<tr>';
												echo'<td class="type-info">1)</td>';
												echo'<td class="type-info">'.$data['Date'].'</td>';
												echo'<td class="type-info">'.$data['fStatus'].'</td>';
												echo '</tr>';
												}
												}
												if(isset($_POST['dateview'])){
                                                 $Date = mysqli_real_escape_string($mysqli, $_POST['date']);
                                                if(strcmp($Date,"dd-mm-yyyy")!=0){
                                                    $date=date_create($Date);
                                                    $Date1=date_format($date,"Y-m-d");
                                                    $uname=$_SESSION["uname"];
                                                    $result=mysqli_query($mysqli,"Select *from Student_Attendance where Student_Reg_Id='$uname' and Date='$Date1'");
												while($data=mysqli_fetch_array($result)){
												echo '<tr>';
												echo'<td class="type-info">1)</td>';
												echo'<td class="type-info">'.$data['Date'].'</td>';
                                                ...
                                                if(strcmp($Month,"Month")!=0){
                                                    switch($Month){
                                                        ...
                                                        case 'November':$Month1='11';
                                                            break;
                                                        case 'December':$Month1='12';
                                                            break;    
                                                    }
                                                    $uname=$_SESSION["uname"];
                                                    $result=mysqli_query($mysqli,"Select *from Student_Attendance where Student_Reg_Id='$uname' and Date like '%$Month1%' ");
												$i=1;
												while($data=mysqli_fetch_array($result)){
												echo '<tr>';
												echo'<td class="type-info">'.$i.')</td>';
												echo'<td class="type-info">'.$data['Date'].'</td>';
												echo'<td class="type-info">'.$data['fStatus'].'</td>';
												echo '</tr>';
												$i=$i+1;
			        		...
			        		<!--<h3>Till now attendance in percentage:-80%</h3>-->
